  ...
  >
    ...
    <el-form-item prop="code" class="mb-8">
      ...
      <div class="flex gap-3 w-full">
        ...
        <div
          class="w-[120px] h-[42px] overflow-hidden rounded-md cursor-pointer hover:opacity-90 transition-opacity shadow-sm"
        >
          <img
    ...
    <el-form-item>
      <el-button
        ...
        size="large"
        type="primary"
        class="w-full h-[44px] !bg-[#1850C5] hover:!bg-[#1545A5] transition-colors duration-300 mt-2"
        @click="submitForm(ruleFormRef)"
      >
        <span class="text-[15px] font-semibold">{{loading ? "登录中" : "登录"}}</span>
      </el-button>
    </el-form-item>
  </el-form>
</template>
